...
select * from people;
--2 update
update people set email = 'teat@gmail.com' where id =1;
--3 new запись в таблицу
insert into people (id,first_name,last_name,email,gender,age,language)
values (51,'Adilet','Egemberdiev','a@gmail.com','male',16,'Kyrgyz');
--4 delete people
...
--8
select sum(age) as summ_age from people;
--9
...
--12
select count(*) as speak_KZ from people where language = 'Kazakh';
--13
select last_name,email from people where gender='Female';
--14
...
--29 Отобразите все записи, кроме родившихся с 24 по 31 лет
